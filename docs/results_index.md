...
| GSM8K synthetic prefix phase3 | planned diagnostic | rationale-contamination check | 9 | planned | planned | - | - | - | - | uses an external rationale definition file for auditability |
